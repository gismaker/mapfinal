...
public class EventKit {
	...
	public static void sendEvent(String action, String name, Object data) {
		EventManager.me().pulish(new Event(action, name, data));
	}

	public static void sendEvent(String action) {
		EventManager.me().pulish(new Event(action));
	}
