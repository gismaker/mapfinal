...
//		System.out.println(json);
		...
		Coordinate c = ConverterManager.use("wgs84To4490", "EPSG:4326", "EPSG:4490").transform(new Coordinate(116.69677734375, 26.82407078047018));
		System.out.println("c: " + c.toString());
		
//		ConverterManager.use("wgs84To4490", "4326", "4490").transform(geom);
//		
//		String jsons = jc.parseJson(geom);
