 ...
 *
 */
public class BufferedImagePickRenderEngine extends BufferedImageRenderEngine implements PickRenderEngine {

	private BufferedImage pickImage;
	private int width = 300;
	private int height = 300;

	public BufferedImagePickRenderEngine(int width, int height) {
		this.width = width;
		this.height = height;
		pickImage = new BufferedImage(width,height, BufferedImage.TYPE_INT_RGB);
		renderStart();
		renderEnd();
	}
