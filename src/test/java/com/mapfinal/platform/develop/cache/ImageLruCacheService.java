...
import com.mapfinal.resource.LruCache;
import com.mapfinal.resource.Resource;

public class ImageLruCacheService implements ImageCacheService {

	private LruCache<String, Object> imageCache;
	
	public ImageLruCacheService(int cacheSize) {
		imageCache = new LruCache<String, Object>(cacheSize);
	}
